...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center p-4 sm:p-8">
      {/* Main Content Card */}
      <div className="max-w-lg w-full bg-white rounded-3xl shadow-xl p-8 sm:p-12 flex flex-col items-center text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
            Ready to dive in? Log in or sign up to start connecting with your friends today.
          </p>
        </div>
